use crate::orderbook::{linked_list::LinkedList, InnerOrder, Oid, OrderBook, Px, Side, Snapshot, Sz};
...
impl Snapshot<InnerLevel> {
    #[must_use]
    pub fn to_l2_snapshot(&self, n_levels: Option<usize>, n_sig_figs: Option<u32>, mantissa: Option<u64>) -> Self {
